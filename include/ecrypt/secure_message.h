...
#ifndef ECRYPT_SECURE_MESSAGE_H
#define ECRYPT_SECURE_MESSAGE_H
 ...
 * @addtogroup ECRYPT
 * @{
 * @defgroup ECRYPT_SECURE_MESSAGE secure message
 ...
 * @return ECRYPT_SUCCESS on success or an error code on failure
 * @note If encrypted_message is NULL or encrypted_message_length is not enough to store the
 * encrypted message then ECRYPT_BUFFER_TOO_SMALL will be returned and encrypted_message_length will
 ...
 *       then ECRYPT_BUFFER_TOO_SMALL will be returned and message_length will contain
 ...
 * message then ECRYPT_BUFFER_TOO_SMALL will be returned and signed_message_length will contain the
 ...
 * storage then ECRYPT_BUFFER_TOO_SMALL will return and wrapped_message_length will store length of
 * buffer needed for wrapped message store
 */
DEPRECATED("use 'ecrypt_secure_message_encrypt' with private and public keys to encrypt message, or 'ecrypt_secure_message_sign' with private key to sign message")
ECRYPT_API
 ...
 * ECRYPT_BUFFER_TOO_SMALL will return and message_length will store length of buffer needed for
 * plain message store
 */
DEPRECATED("use 'ecrypt_secure_message_decrypt' with private and public key to decrypt message or 'ecrypt_secure_message_verify' with public key to verify signed message")
ECRYPT_API
