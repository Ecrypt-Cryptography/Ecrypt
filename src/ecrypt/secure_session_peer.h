...
#ifndef ECRYPT_SECURE_SESSION_PEER_H
#define ECRYPT_SECURE_SESSION_PEER_H
...
ecrypt_status_t secure_session_peer_init(secure_session_peer_t* peer,
                                         const void* id,
                                         size_t id_len,
                                         const void* ecdh_key,
                                         size_t ecdh_key_len,
...
#endif /* ECRYPT_SECURE_SESSION_PEER_H */
