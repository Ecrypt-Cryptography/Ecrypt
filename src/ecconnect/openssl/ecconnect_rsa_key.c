...
static size_t rsa_pub_key_size(int mod_size)
{
    switch (mod_size) {
    case 128: /* 1024 */
        return sizeof(ecconnect_rsa_pub_key_1024_t);
    case 256: /* 2048 */
        return sizeof(ecconnect_rsa_pub_key_2048_t);
    case 512: /* 4096 */
        return sizeof(ecconnect_rsa_pub_key_4096_t);
    case 1024: /* 8192 */
        return sizeof(ecconnect_rsa_pub_key_8192_t);
    default:
        return 0;
    }
}
...
static size_t rsa_priv_key_size(int mod_size)
{
    switch (mod_size) {
    case 128: /* 1024 */
        return sizeof(ecconnect_rsa_priv_key_1024_t);
    case 256: /* 2048 */
        return sizeof(ecconnect_rsa_priv_key_2048_t);
    case 512: /* 4096 */
        return sizeof(ecconnect_rsa_priv_key_4096_t);
    case 1024: /* 8192 */
        return sizeof(ecconnect_rsa_priv_key_8192_t);
    default:
        return 0;
    }
}
...
static ecconnect_status_t bignum_to_bytes(const BIGNUM* bn, uint8_t* to, size_t to_length)
{
                                                    ...
                                                    size_t* key_length)
{
    ...
    memcpy(key->tag, rsa_pub_key_tag(rsa_mod_size), ECCONNECT_CONTAINER_TAG_LENGTH);
                                                     ...
                                                     size_t* key_length)
{
    ...
    memcpy(key->tag, rsa_priv_key_tag(rsa_mod_size), ECCONNECT_CONTAINER_TAG_LENGTH);
    key->size = htobe32(output_length);
    ecconnect_update_container_checksum(key);
    *key_length = output_length;
    res = ECCONNECT_SUCCESS;
