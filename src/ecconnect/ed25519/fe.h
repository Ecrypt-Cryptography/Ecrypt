...
#define ECCONNECT_ED25519_NO_UBSAN __attribute__((no_sanitize( \
    "shift", \
...
#define ECCONNECT_ED25519_NO_UBSAN __attribute__((no_sanitize("undefined")))
#else
#define ECCONNECT_ED25519_NO_UBSAN
#endif
